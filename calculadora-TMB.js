...
switch (sexo) {
    case "1":
        ...
        console.log('Atividade Baixa: ',(tmbMasculino*atvBaixa).toFixed(2),'kcal');
        console.log('Atividade Media: ',(tmbMasculino*atvMedia).toFixed(2),'kcal');
        console.log('Atividade Alta: ',(tmbMasculino*atvAlta).toFixed(2),'kcal');
        console.log('--------------------------------------------------------')
        ...
        case "2":
        console.log('--------------------------------------------------------')
        console.log('TMB Feminino: ', tmbFeminino.toFixed(2),'kcal');
        console.log('Atividade Baixa: ',(tmbFeminino*atvBaixa).toFixed(2),'kcal');
        console.log('Atividade Media: ',(tmbFeminino*atvMedia).toFixed(2),'kcal');
        console.log('Atividade Alta: ',(tmbFeminino*atvAlta).toFixed(2),'kcal');
        console.log('--------------------------------------------------------')
        console.log(`Você deve beber ${qtdAgua}ml de água por dia.`)
        console.log('Você deve consumir ',(proteinas*tmbFeminino).toFixed(2),'g de proteínas por dia.')
        console.log('Você deve consumir ',(gorduras*tmbFeminino).toFixed(2),'g de gorduras por dia.')
        console.log('Você deve consumir ',(carboidratos*tmbFeminino).toFixed(2),'g de carboidratos por dia.')
        break;
}
